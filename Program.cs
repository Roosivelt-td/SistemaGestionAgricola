...
// Add Swagger - CONFIGURACIÓN MEJORADA
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        ...
        Version = "v1",
        Description = "API para el sistema de gestión agrícola con autenticación JWT"
    });
    ...
    // Incluir comentarios XML (opcional pero recomendado)
